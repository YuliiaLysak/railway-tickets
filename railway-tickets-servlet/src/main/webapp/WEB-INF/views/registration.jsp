...
<div class="signup-form">
    <form action="${pageContext.request.contextPath}/registration" method="post">
        ...
        <p class="lead"><fmt:message key="signUpText"/></p>
        ...
        <div class="form-group d-grid gap-2">
            <button type="submit" class="btn btn-primary btn-block btn-lg"><fmt:message key="signup"/></button>
        </div>
    </form>
    <div class="text-center">
        <span><fmt:message key="withAccount"/></span>
